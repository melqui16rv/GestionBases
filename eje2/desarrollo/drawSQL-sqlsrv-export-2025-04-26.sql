...
CREATE TABLE "TipoAcceso"(
    "id_tipoAcceso" INT NOT NULL AUTO_INCREMENT,
    "Nombre" VARCHAR(55) NOT NULL,
    "Descripcion" TEXT NOT NULL
);
ALTER TABLE
...
CREATE TABLE "HistorialAcceso"(
    "id_historialAcceso" INT NOT NULL AUTO_INCREMENT,
    "fecha" DATETIME NOT NULL,
...
CREATE TABLE "rolTipoAcceso"(
    "id_rolTipoAcceso" INT NOT NULL AUTO_INCREMENT,
    "id_tipoAcceso" INT NOT NULL,
    "it_rol" INT NOT NULL
);
ALTER TABLE
...
CREATE TABLE "tipoAccion"(
    "id_tipoAccion" INT NOT NULL AUTO_INCREMENT,
    "nombre" VARCHAR(55) NOT NULL
);
ALTER TABLE
...
ALTER TABLE
    "rolTipoAcceso" ADD CONSTRAINT "roltipoacceso_it_rol_foreign" FOREIGN KEY("it_rol") REFERENCES "Rol"("id_rol");
ALTER TABLE
...
ALTER TABLE
    "Rol" ADD CONSTRAINT "rol_id_rol_foreign" FOREIGN KEY("id_persona") REFERENCES "Persona"("Cedula");
ALTER TABLE
...
ALTER TABLE
    "Empleado" ADD CONSTRAINT "empleado_id_empleado_foreign" FOREIGN KEY("id_persona") REFERENCES "Persona"("Cedula");
ALTER TABLE
