...
3. [ALCANCE](#alcance)
4. [COMPONENTE 1: ADMINISTRACIÓN DE DATOS Y ACCESOS](./1-administracion-datos-accesos.md)
5. [COMPONENTE 2: COPIAS DE SEGURIDAD Y SEGURIDAD FÍSICA](./2-copias-seguridad-fisica.md)
6. [COMPONENTE 3: RECURSOS HUMANOS Y CONTROL DE ACCESO](./3-recursos-humanos-control-acceso.md)
7. [COMPONENTE 4: DESARROLLO DE APLICACIONES Y DISPOSITIVOS](./4-desarrollo-aplicaciones-dispositivos.md)
